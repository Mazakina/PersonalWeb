  ...
  return (
        <section className={styles.home}>
          <div className={styles.centerContent}>
                  ...
                  <SvgTriangle polygonClass={'/images/back.png'} className={styles.firstTriangle} sizeMultiplier={16.5} colors={{firstColor:"#FE5B00",secondColor:"#3E1A18"}} offset={{firstColor:"0%",secondColor:"100%"}}/>
